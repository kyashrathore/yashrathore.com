      ...
      <SectionContainer>
        <main>
          <article>
            ...
            >
              <dl className="pt-6 pb-10 xl:pt-11  xl:mr-4">
                <dt className="sr-only">Authors</dt>
                <dd>
                  <ul className="flex justify-center xl:block space-x-8 sm:space-x-12 xl:space-x-0 xl:space-y-8">
                    {meta.authors.map((author) => (
                      <li key={author.twitter} className="flex items-center space-x-2">
                        ...
                        <dl className="text-sm font-medium leading-5 whitespace-no-wrap">
                          <dt className="sr-only">Name</dt>
                          <dd className="text-white">{author.name}</dd>
              ...
              <footer className="text-sm font-medium leading-5xl:col-start-1 xl:row-start-2">
                {(next || previous) && (
                  <div className="space-y-8 py-8">
                    {next && (
                      <div>
                        <h2 className="text-xs tracking-wide uppercase text-white">Next Article</h2>
                    ...
                    {previous && (
                      <div>
                        <h2 className="text-xs tracking-wide uppercase text-white">
                          Previous Article
                        </h2>
                        <div className="text-white hover:text-gray-500">
